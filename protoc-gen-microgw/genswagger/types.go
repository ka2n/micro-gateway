...
type swaggerOperationObject struct {
	...
	Security    swaggerSecuritiesObject `json:"security,omitempty"`
...
type swaggerSecuritiesObject []map[string]swaggerSecurityScopeObject

type swaggerSecurityScopeObject []string
...
type securitiesMap map[string]*descriptor.Security
